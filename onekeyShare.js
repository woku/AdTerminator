(function(){
    var TIPS = '<div class="ad-controls"><span class="ad-contrrols-close" data-dismiss="alert">×</span><ul class="ad-operat"><li class="alert"><strong>广告终结者</strong>已经为您屏蔽视频片头广告，暂停广告和右下角广告。<a>了解详情>></a></li><li class="dropd-li"><a href="javascript:;"><i id="ad-share"></i>分享</a><ul class="ad-dropd"><li><a href="javascript:;" class="os-sina-weibo">新浪微博</a></li><li><a href="javascript:;" class="os-qq-zone">QQ空间</a></li><li><a href="javascript:;" class="os-renren">人人网</a></li><li><a href="javascript:;" class="os-qq-friends">QQ好友</a></li><li><a href="javascript:;" class="os-tenc-weibo">腾讯微博</a></li><li><a href="javascript:;" class="os-douban">豆瓣</a></li></ul></li><li><a href="http://woku1.com/adt" target="_blank"><i id="ad-home"></i>主页</a></li><li class="dropd-li"><a href="javascript:;"><i id="ad-follow"></i>关注</a><ul class="ad-dropd"><li><a href="http://weibo.com/liulanqichajian" target="_blank">关注新浪微博</a></li><li><a href="http://t.qq.com/baotianshuai" target="_blank">关注腾讯微博</a></li><li><a href="http://liulanqichajian.t.sohu.com/" target="_blank">关注搜狐微博</a></li><li><a href="http://t.163.com/liulanqichajian" target="_blank">关注网易微博</a></li></ul></li><li class="dropd-li"><a href="javascript:;"><i id="ad-reply"></i>反馈<a/><ul class="ad-dropd"><li><a>问题报告</a></li><li><a>意见反馈</a></li></ul></li><li><a href="'+chrome.extension.getURL("options.html")+'" target="_blank"><i id="ad-set"></i>设置</a></li></ul></div>';
    var UTIL = {
        ...
        for (var i = 0; i < drops.length; i++) {
            drops[i].addEventListener('click',function(e){
                ...
                if(style.display == "none" || style.display.length == 0){
                    ...
                    var alldrops = document.body.querySelectorAll(".ad-dropd");
    ...
    function onekeyShare(option) {
        ...
        param = UTIL.extend(param,option);
    ...
    function tips() {
        ...
        //setting
    chrome.extension.sendRequest({reqtype: "should-show-video-tips"}, function(response) {
        if(!response.enabled){tips();}
    });
})();